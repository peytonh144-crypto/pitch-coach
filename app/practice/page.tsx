...
import { PERSONAS, SCENARIOS, type PersonaKey, type ScenarioKey } from "@/lib/personas";
      ...
      <main className="flex w-full max-w-2xl flex-1 flex-col gap-6 px-6 py-12">
        <header className="flex flex-col gap-2">
          ...
          <p className="text-sm text-zinc-400">
            Roleplay a door conversation with an AI homeowner. Choose a persona and scenario, then practice your pitch.
          </p>
        </header>
        ...
        {!started ? (
          <section className="flex flex-col gap-4 rounded-lg border border-zinc-800 bg-zinc-900 px-4 py-4">
            <div className="flex flex-col gap-2">
              <label htmlFor="persona" className="text-sm font-medium text-zinc-300">
                Homeowner persona
              </label>
              <select
                id="persona"
            ...
            <div className="flex flex-col gap-2">
              <label htmlFor="scenario" className="text-sm font-medium text-zinc-300">
                Scenario
              </label>
              <select
                id="scenario"
          ...
          <section className="flex flex-1 flex-col gap-3">
            <div className="flex items-center justify-between">
              <div className="text-xs text-zinc-500">
                {PERSONAS[persona as PersonaKey]?.label.split(" — ")[0]} · {SCENARIOS[scenario as ScenarioKey]?.label.split(" — ")[0]}
              </div>
