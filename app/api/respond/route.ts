...
function buildSystemPrompt(opts: {
  ...
  const persona = PERSONAS[opts.persona as PersonaKey];
  if (persona && persona.coachStrategy) {
    lines.push(
      `The homeowner you're advising on appears to be this type: ${persona.coachStrategy}. Tailor your suggested response and next move to fit this persona.`,
    );
  }
